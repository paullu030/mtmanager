   ...
   enum EnFlags
     {
      ...
      FLAG_NOTIFY_CLIENTS        =0x00000004,  // можно использовать для уведомлеия трейдеров
      FLAG_NOTIFY_SERVICES       =0x00000008,  // можно использовать для внутренних сервисов и автоматизации
      //--- flags borders
